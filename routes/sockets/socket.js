...
// const {E } = require("../../models/add_employee");
...
module.exports = (io) => {
  io.use(async (socket, next) => {
    try {
      ...
      const user = await mongoFunctions.find_one("Employees",{ username: decoded.username });
  ...
  io.on("connection", async (socket) => {
    ...
    await mongoFunctions.update_one("Employees",
      { username },
      {
